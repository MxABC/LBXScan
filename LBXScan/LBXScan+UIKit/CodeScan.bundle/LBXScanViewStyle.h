...
//  LBXScanDemo
//
//  Created by csc on 15/11/15.
//  Copyright © 2015年 csce. All rights reserved.
//
 ...
 */
@property (nonatomic, assign) BOOL isNeedScanRetangle;

/**
 *  扫码区域是否显示为正方形,默认YES
 */
@property (nonatomic, assign) BOOL isScanRetangelSquare;
...
/**
 @brief  矩形框线条颜色,范围0--1,默认白色 (1,1,1,1)
 */
@property (nonatomic, assign) CGFloat red_RetangleLine;
@property (nonatomic, assign) CGFloat green_RetangleLine;
@property (nonatomic, assign) CGFloat blue_RetangleLine;
@property (nonatomic, assign) CGFloat alpa_RetangleLine;
